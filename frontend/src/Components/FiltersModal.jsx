          ...
          >
            ...
            {expanded === "accessibility" && (
              <div className="accordion-body accessibility-options">
                ...
                <label>
                  <input type="checkbox" /> Step-free access
                </label>
                <label>
                  <input type="checkbox" /> Disabled parking spot
                </label>
                <label>
                  <input type="checkbox" /> Guest entrance wider than 32 inches
                  (81 centimetres)
                </label>
